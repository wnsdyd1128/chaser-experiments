...
volatile double data[M][N];
volatile double corr[N][N];
volatile double mean[N];
volatile double stddev[N];

__attribute__((noinline,annotate("ape.analyze"))) void correlation_kernel() {
    int i, j, k;
    double eps = 0.1;
